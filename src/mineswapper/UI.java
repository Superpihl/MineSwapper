...
public class UI extends JFrame
{
    ...
    // Frame settings
    private final String FRAME_TITLE = "MineSwapper ~ Developed by Emil M, Frederik N & Noel";
    
    private int FRAME_WIDTH = 850;
    private int FRAME_HEIGHT = 800;
    private int FRAME_LOC_X = 200;
    ...
    public void buttenthingy(int x,int y,int n)
    {              
        buttons[x][y].setText(Integer.toString(n)); 
        //Opdatere teksten på feltet
        if(n == 0){
           buttons[x][y].setText(""); 
            //Hvis tallet er 0 laver den et tomt felt istedet
        }
        buttons[x][y].setIcon(null); 
        //fjerne eventuele iconer fra feltet
        buttons[x][y].setBackground(Color.lightGray); 
        //justere baggrundsfarven
        setTextColor(buttons[x][y]); 
        //opdatere teksten på feltets farve
    }
